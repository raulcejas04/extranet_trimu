 ...
 * Usuarios
 *
 * @ORM\Table(name="USUARIOS",  uniqueConstraints={@ORM\UniqueConstraint(name="UNIQ_8D93D649F85E0677", columns={"cUsuario"})})
 * @ORM\Entity
 */
class Usuarios
{
     ...
     * @var string
     *
     * @ORM\Column(name="C_USUARIO", type="string", length=30, nullable=false)
     * @ORM\Id
     * @ORM\GeneratedValue(strategy="SEQUENCE")
     * @ORM\SequenceGenerator(sequenceName="USUARIOS_C_USUARIO_seq", allocationSize=1, initialValue=1)
     */
    private $cUsuario;
     ...
     * @var string
     *
     * @ORM\Column(name="C_USUARIOALT", type="string", length=30, nullable=false)
     */
    private $cUsuarioalt;
     ...
     * @var string|null
     *
     * @ORM\Column(name="C_TOKEN", type="string", length=100, nullable=true)
     */
    private $cToken;
     ...
     * @var string|null
     *
     * @ORM\Column(name="D_OBSERVACION_BAJA", type="string", length=1000, nullable=true)
     */
    private $dObservacionBaja;
